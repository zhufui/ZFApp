 ...
 * 18.获取参数
 * 19.操作fragment
 * 20.获取同级别最后加入的fragment
 * 21.获取栈中同级别最后加入的fragment
 * 22.根据栈参数获取同级别最后加入的fragment
 * 23.获取顶层可见fragment
 * 24.获取栈中顶层可见fragment
 * 25.根据栈参数获取顶层可见fragment
 * 26.获取同级别fragment
 * 27.获取栈中同级别fragment
 * 28.根据栈参数获取同级别fragment
 * 29.获取所有fragment
 * 30.获取栈中所有fragment
 * 31.根据栈参数获取所有fragment
 * 32.获取目标fragment的前一个fragment
 * 33.查找fragment
 * 34.处理fragment回退键
 * 35.设置背景色
 * 36.设置背景资源
